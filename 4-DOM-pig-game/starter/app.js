...
var scores, roundScore, activePlayer, dicePrev, winScore, gamePlaying;
...
function displayWinScore(winScore) {
    document.querySelector('.win-score-display').textContent = 'Winning score : ' + winScore;
}
